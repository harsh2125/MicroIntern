import { A as deepEqual, C as Logger, E as FirebaseError, F as getModularInstance, I as getUA, N as getDefaultEmulatorHostnameAndPort, O as createMockUserToken, S as LogLevel, V as isIndexedDBAvailable, W as isSafari, b as registerVersion, c as _getProvider, d as _registerComponent, f as _removeServiceInstance, h as getApp, n as SDK_VERSION, w as Component } from "./index.esm2017-C0Kz9nl8.js";
	...
	*/ async pu() {
	...
	gu(e) {
		const t = this.mu.then((() => (this.du = !0, e().catch(((e) => {
			...
			* limitations under the License.
			*/
			throw __PRIVATE_logError("INTERNAL UNHANDLED ERROR: ", function __PRIVATE_getMessageOrStack(e) {
				let t = e.message || "";
